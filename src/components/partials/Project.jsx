...
const Project = (props) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full h-fit sm:h-[300px] rounded-md mx-auto bg-white shadow-2xl hover:shadow-blue-200 hover:scale-[1.03] transition-all duration-300 flex flex-col sm:flex-row overflow-hidden border border-[#e0e7ef]"
    >
      {/* Image section */}
