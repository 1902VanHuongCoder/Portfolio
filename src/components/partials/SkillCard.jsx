...
const SkillCard = (props) => {
  ...
  return (
    <motion.div className=" bg-gradient-to-tr from-[#33A1E0] to-[#1E3A8A] w-[100%] rounded-[6px] flex flex-col items-center justify-between gap-y-2 py-4 drop-shadow-2xl">
